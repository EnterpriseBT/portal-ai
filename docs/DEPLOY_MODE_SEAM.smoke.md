...
- [ ] **Stripe webhook is gone**: `curl -s -o /dev/null -w "%{http_code}\n" -X POST http://localhost:3001/api/webhooks/stripe -H "stripe-signature: t=1,v1=x" -d '{}'` → **404** (route not registered).
