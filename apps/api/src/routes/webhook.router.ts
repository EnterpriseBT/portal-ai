...
// removed in #577: on-first-token provisioning (metadata.middleware +
// ApplicationService.ensureProvisioned) makes it redundant and drops the
// Auth0-Action dependency. The Stripe + AWS-marketplace webhooks below stay.
