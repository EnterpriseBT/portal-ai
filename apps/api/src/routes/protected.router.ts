...
import { rbacObjectSearchRouter } from "./rbac-object-search.router.js";
...
protectedRouter.use("/grants", grantRouter);
protectedRouter.use("/policies", policyRouter);
protectedRouter.use("/roles", roleRouter);
protectedRouter.use("/groups", groupRouter);
protectedRouter.use("/rbac", rbacObjectSearchRouter);
