...
import {
  ...
  permissionPoliciesRepo,
  permissionStatementsRepo,
  policyAttachmentsRepo,
...
export class DbService {
  ...
  static get repository() {
    return {
      ...
      permissionPolicies: permissionPoliciesRepo,
      permissionStatements: permissionStatementsRepo,
      policyAttachments: policyAttachmentsRepo,
      permissionGrants: permissionGrantsRepo,
      roles: rolesRepo,
      userRole: userRolesRepo,
      groups: groupsRepo,
      ...
      curatedViews: curatedViewsRepo,
      curatedViewFieldMappings: curatedViewFieldMappingsRepo,
      stationViews: stationViewsRepo,
      portals: portalsRepo,
